    ...
    q.prototype = {
        ...
        pointerMove: function (a) {
            ...
            var b = this.options.min, d = this.options.max,
                c = b.toString().split(".")[1], e = d.toString().split(".")[1], f, l, g = 0, k = 0;
            ...
            k < this.options.min ? k = this.options.min : k > this.options.max &&
                (k = this.options.max);
            return k
            ...
            if (c) for (a.p_values = [], a.min = 0, a.max = c - 1, a.step =
                1, a.grid_num = a.max, a.grid_snap = !0, f = 0; f < c; f++) e = +d[f], isNaN(e) ? e = d[f] : (d[f] = e, e = this._prettify(e)), a.p_values.push(e);
